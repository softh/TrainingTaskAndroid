...
- Каждый функциональный модуль приложения должен быть полностью завершен и функционировать. Не допускается частичная или полная неработоспособность функционального модуля.

## Архитектурные требования
- В приложении должны быть использованы `Порождающие`, `Структурные` и `Поведенческие` паттерны
- Приложение должно быть разработано с Clean Architecture подходом и использоваться один из паттернов (MVP/MVVM/MVI/MVC)

## Работа с исходным кодом
- Исходный код должен быть документирован и содержать сведения об авторе
